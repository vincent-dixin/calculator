var UIGeneral = function () {
    ...
    var handleDynamicPagination = function() {
        $('#dynamic_pager_demo1').bootpag({
            ...
            $("#dynamic_pager_content1").html("Params " + num + " content here"); // or some ajax content loading...
        });
        ...
        $('#dynamic_pager_demo2').bootpag({
            ...
            $("#dynamic_pager_content2").html("Params " + num + " content here"); // or some ajax content loading...
        });
    }
